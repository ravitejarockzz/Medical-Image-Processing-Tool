#include "cpu/HarrisCorner.h" // Adjust path if your folder structure is different
#include "factory/FilterFactory.h"

#include <opencv2/imgproc.hpp>
#include <stdexcept>

cv::Mat HarrisCornerCPU::apply(
    const cv::Mat& input,
...
REGISTER_CPU_FILTER(HarrisCornerCPU, "harris_corner")